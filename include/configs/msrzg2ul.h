...
#define CONFIG_DRAM_SIZE		0x40000000u /* 1 GB */
#else
#define CONFIG_DRAM_SIZE		0x20000000u /* 512 MB */
#endif
#define DRAM_RSV_SIZE			0x08000000
#define CONFIG_SYS_SDRAM_BASE		(CONFIG_DRAM_SIZE + DRAM_RSV_SIZE)
#define CONFIG_SYS_SDRAM_SIZE		(CONFIG_DRAM_SIZE - DRAM_RSV_SIZE)
#define CONFIG_SYS_LOAD_ADDR		0x58000000
#define CONFIG_LOADADDR			CONFIG_SYS_LOAD_ADDR // Default load address for tfpt,bootp...
#define CONFIG_VERY_BIG_RAM
#define CONFIG_MAX_MEM_MAPPED		(CONFIG_DRAM_SIZE - DRAM_RSV_SIZE)
